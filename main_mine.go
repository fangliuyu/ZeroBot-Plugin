...
import (
	...
	_ "github.com/FloatTech/ZeroBot-Plugin/plugin/_personal/google_translation" // 自制谷歌翻译
...
func init() {
	...
	// 默认昵称
	adana := flag.String("n", "娮儿", "Set default nickname.")
	...
	config.Z = zero.Config{
		NickName:      append([]string{*adana}, "柳如娮", "小娮", "如娮", "Ruby", "ruby"),
